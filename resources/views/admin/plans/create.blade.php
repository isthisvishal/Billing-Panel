...
<div class="page-header">
    <h1><i class="fas fa-box"></i> Create Plan</h1>
</div>
                ...
                <form action="{{ route('admin.plans.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               name="name" value="{{ old('name') }}" required placeholder="e.g., Starter">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                               name="slug" value="{{ old('slug') }}" required placeholder="e.g., starter-plan">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_monthly') is-invalid @enderror" 
                                       name="price_monthly" value="{{ old('price_monthly') }}" placeholder="9.99">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_yearly') is-invalid @enderror" 
                                       name="price_yearly" value="{{ old('price_yearly') }}" placeholder="99.99">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_lifetime') is-invalid @enderror" 
                                       name="price_lifetime" value="{{ old('price_lifetime') }}" placeholder="299.99">
